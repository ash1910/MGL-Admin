...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('item') }}'><i class='nav-icon la la-list'></i> Swatch Library</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('fabric-category') }}'><i class='nav-icon la la-list'></i> Fabric Categories</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('quotation') }}'><i class='nav-icon la la-list'></i> Quotation List</a></li>
